...
### --- Main Loop --- ###
def main():
    state = "MENU" # -New- Added a state system to handle different screens
    n = 5
    grid, row_sums, col_sums, user_sel = [], [], [], [] # -New- They now be filled later, to make multiple games possible
    won = False
    
    # -New- Added buttons for the menu
    btn_start = pygame.Rect(WIDTH//2 - 100, 200, 200, 50)
    btn_quit = pygame.Rect(WIDTH//2 - 100, 270, 200, 50)
    ...
    while True:
        ...
        if state == "MENU":
            ...
            draw_button(btn_start, "Play", btn_start.collidepoint(mx, my))

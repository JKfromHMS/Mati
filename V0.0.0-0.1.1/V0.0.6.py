...
def main():
    ...
    won = False
    timer_enabled = False # -New- save if the timer is on or off
    timer_ms = False # -New- same for special role of miliseconds
    ...
    btn_about = pygame.Rect(WIDTH//2 - 100, 250, 200, 50) # Add a button for the about menu
    btn_toggle_timer = pygame.Rect(WIDTH//2 - 100, 170, 200, 50) # -New- Added a button for the timer
    btn_toggle_ms = pygame.Rect(WIDTH//2 - 100, 240, 200, 50) # -New- Toggle for ms
    ...
    while True:
        ...
        if state == "PLAY" and not won: # -New- To track the time
        ...
        if state == "MENU":
            ...
            if timer_enabled:
                ...
                btn_about = pygame.Rect(WIDTH//2 - 100, 310, 200, 50)
                ...
                btn_about = pygame.Rect(WIDTH//2 - 100, 240, 200, 50)
                draw_button(btn_about, "About", btn_about.collidepoint(mx, my))

...
def draw_history(game, mx, my): # Draw the history
    ...
    w.draw_scrollbar(track, len(entries) * con.ENTRY_SPACING, track.height, -game.history_scroll_y, mx, my, game.history_scroll_last) # draw the scrollbar
...
def draw_history_detail(game, mx, my): # the draw the detailed history view
    ...
    for i, act in enumerate(display_actions):
        ...
        real_index = helpers.detail_real_index_for(i) # get the real index

...
### V0.3.2 Beta V1.0.16 ###
### Author: Janosch Klawatsch, 29.07.2026 ###
### game file V0.3.6 ###
...
class Game: # Create a class
    ...
    def __init__(self, sounds): # Every class need a init with the start parameters
        ...
        self.live_clock_enabled = self.settings.get("live_clock_enabled", False) # Trackes if the real time should be shown
        self.live_clock_ms = self.settings.get("live_clock_ms", False) # Trackes if the real time should show ms
        self.ultra_timer_enabled = self.settings.get("ultra_timer_enabled", False) # Trackes if the ultra ingame time should be shown
        self.ultra_timer_ms = self.settings.get("ultra_timer_ms", False) # Trackes if that ingame time shows ms
        self.ultra_timer_show_clock = self.settings.get("ultra_timer_show_clock", False) # Trackes if the real time should follow the ingame time
    ...
    def persist_settings(self): # Save the current settings
        self.settings = {
            ...
            "live_clock_ms": self.live_clock_ms,

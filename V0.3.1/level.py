...
### V0.3.1 Beta V1.0.15 ###
### Author: Janosch Klawatsch, 26.07.2026 ###
### level file V0.3.3 ###
...
def letter(n, letter_char): # Defines letters
    ...
    if letter_char == "A": # If the letter is A
        if n == 5: # 5x5 grid
            cover = [
                F,T,T,T,F,
                T,F,F,F,T,
    ...
    elif letter_char == "B": # If the letter is B
        if n == 5: # 5x5 grid
            cover = [
                T,T,T,T,F,
                T,F,F,F,T,
    ...
    elif letter_char == "C": # If the letter is C
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "D": # If the letter is D
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "F": # If the letter is F
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "G": # If the letter is G
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "H": # If the letter is H
        if n == 5: # 5x5 grid
            cover = [
                T,F,F,F,T,
                T,F,F,F,T,
    ...
    elif letter_char == "I": # If the letter is I
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "J": # If the letter is J
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "K": # If the letter is K
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "P": # If the letter is P
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "Q": # If the letter is Q
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "R": # If the letter is R
        if n == 5: # 5x5 grid
            cover = [
                T,T,T,T,F,
                T,F,F,F,T,
    ...
    elif letter_char == "S": # If the letter is S
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "T": # If the letter is T
        if n == 5: # 5x5 grid
            cover = [
                T,T,T,T,T,
                F,F,T,F,F,
    ...
    elif letter_char == "U": # If the letter is U
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "W": # If the letter is W
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "X": # If the letter is X
        if n == 5: # 5x5 grid
            cover = [
    ...
    elif letter_char == "Z": # If the letter is Z
        if n == 5: # 5x5 grid
            cover = [

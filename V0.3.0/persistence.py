...
def load_settings_and_stats(): # Load settings, stats and paused games
    ...
    return settings, stats, paused # Give everything back

def save_settings_and_stats(settings, stats, paused): # Save the settings, stats and paused games in a file
    data = {"settings": settings, "stats": stats, "paused": paused} # Bundle everthing 

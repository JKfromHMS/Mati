...
### V0.6.3 (Beta V1.0.24) ###
### Author: Janosch Klawatsch, 2026-08-31 ###
### config file V0.6.6.1 ###
...
HISTORY_VISIBLE_BOTTOM = HEIGHT - 10
HANNAH_VISIBLE_LENGTH = WIDTH - 40
...
TOGGLE_ON_COLOR = (70, 180, 95)      # Active toggle state: green
TOGGLE_ON_HOVER = (45, 145, 70)      # Hovered active toggle: darker green
TOGGLE_OFF_COLOR = (120, 95, 140)    # Inactive toggle state: muted blue-red blend
TOGGLE_OFF_HOVER = (95, 70, 110)     # Hovered inactive toggle: darker blue-red blend
...
BUTTON_GREY_HOVER = (186, 230, 220)  # 
BUTTON_GREY_COLOR = (212, 255, 245)  # 
BUTTON_GREY_BORDER = (121, 212, 191) # 
TURQUIS = (41, 255, 251)
GREEN_NEON = (0, 255, 0)
GOLDEN = (234, 211, 0)
SKYBLUE = (24, 131, 255)
...
ENTRY_SPACING = 52 # The place between two entries
...
INPUT_ORDER_FRONT_OPTIONS = [INPUT_ORDER_OPTIONS[2], INPUT_ORDER_OPTIONS[3]]
INPUT_ORDER_BACK_OPTIONS = [INPUT_ORDER_OPTIONS[0], INPUT_ORDER_OPTIONS[1]]
INPUT_ORDER_LABELS = {

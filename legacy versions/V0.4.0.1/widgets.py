...
### Author: Janosch Klawatsch, 07.08.2026 ###
### widgets file V0.4.1 ###
...
from datetime import datetime as dt # for th elive clock
...
### For a button ###
def draw_button(rect, text, is_hovered, enabled=True, focused=False): # Get the information about the button

...
### -Functions- ###
def _make_tone(freq, duration_ms, volume=0.3333): # Create a tone
...
def _make_jingle(notes, note_ms=90, volume=0.3333): # Gernate more tones to a jingle
    buf = ar.array("h") # Generate an array
...
class Sounds: # Handle sound play
    def __init__(self): # Inititalize the class
        ...
        try: # If all possible do
            ...
            self.dim = _make_tone(300, 45, 0.2)    # Right click sound
